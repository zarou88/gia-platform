...
var DEFAULTS = {
  ...
  language: '',
  // Months' name.
  months: ['January', 'تنننننننننننننن', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
  // Shorter months' name.
  monthsShort: ['Jan', 'Feb', 'ننتتتتتتت', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
